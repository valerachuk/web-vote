...
namespace WebVote.Data.Migrations
{
    ...
    [Migration("20210512223106_RegistrationLog")]
    partial class RegistrationLog
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebVote.Data.Entities.RegistrationLogRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebVote.Data.Entities.RegistrationLogRecord", b =>
                {
                    b.HasOne("WebVote.Data.Entities.Person", "ByWhom")
                        .WithMany("RegisteredUsers")
                        .HasForeignKey("ByWhomId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebVote.Data.Entities.Person", "ToWhom")
                        .WithOne("RegisteredByLogRecord")
                        .HasForeignKey("WebVote.Data.Entities.RegistrationLogRecord", "ToWhomId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WebVote.Data.Entities.Person", b =>
                {
                    ...
                    b.Navigation("RegisteredByLogRecord");
